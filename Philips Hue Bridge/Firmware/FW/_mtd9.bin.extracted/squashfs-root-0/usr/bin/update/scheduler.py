    ...
    async def __scheduler_task(self):
        ...
        try:
            while True:
                ...
                while self.__event_heap and self.__event_heap[0].event.when - now_s() < 1:
                ...
                if self.__event_heap:
                    next_event_due_in_s = self.__event_heap[0].event.when - now_s()
